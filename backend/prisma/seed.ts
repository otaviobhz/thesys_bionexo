  ...
  if (!existingCot) {
    await prisma.cotacao.create({
      data: {
        ...
        itens: {
          create: [
            { sequencia: 1, descricaoBionexo: 'SERINGA 10ML LUER LOCK S/ AGULHA', quantidade: 500, unidadeMedida: 'CX', marcas: 'BD, Injex', formaPagamento: '30 DDL', categoria: CategoriaItem.NAO_ANALISADO, catComercial: 'Mat. Hospitalar' },
            { sequencia: 2, descricaoBionexo: 'GAZE ESTERIL 13 FIOS 7,5X7,5CM', quantidade: 1000, unidadeMedida: 'PCT', marcas: 'Cremer', formaPagamento: '30 DDL', categoria: CategoriaItem.NAO_ANALISADO, catComercial: 'Mat. Hospitalar' },
            { sequencia: 3, descricaoBionexo: 'LUVA CIRURGICA ESTERIL TAM 7.5', quantidade: 200, unidadeMedida: 'PAR', marcas: 'Supermax, Medline', formaPagamento: '30 DDL', categoria: CategoriaItem.NAO_ANALISADO, catComercial: 'Mat. Cirúrgico' },
          ],
        },
      },
    })
    ...
    await prisma.cotacao.create({
      data: {
        ...
        itens: {
          create: [
            { sequencia: 1, descricaoBionexo: 'CATETER INTRAVENOSO 18G', quantidade: 300, unidadeMedida: 'UN', marcas: 'BD, Jelco', formaPagamento: '28 DDL', categoria: CategoriaItem.NAO_ANALISADO, catComercial: 'Mat. Hospitalar' },
            { sequencia: 2, descricaoBionexo: 'FIO SUTURA NYLON 3-0 C/ AGULHA', quantidade: 100, unidadeMedida: 'ENV', marcas: 'Ethicon, Brasuture', formaPagamento: '28 DDL', categoria: CategoriaItem.NAO_ANALISADO, catComercial: 'Mat. Cirúrgico' },
          ],
        },
      },
    })
